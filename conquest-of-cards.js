...
function homeScreen(message, prefix) {
    ...
    if (char) {
        ...
        var secondInterval;
        message.channel.send(`Opening your Starter Flask in 10 seconds... <:sifcasinocoinloader:566407216790503434>`).then((message) => {
            secondInterval = setInterval(() => {
                if (seconds == 0) {
                    ...
                    seconds--;
                    message.edit(`Opening your *Starter Flask* in ${seconds} seconds... <:sifcasinocoinloader:566407216790503434>`);
                }
            }, 1000);
        });
    }
